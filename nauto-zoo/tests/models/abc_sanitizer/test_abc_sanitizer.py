...
$ python -m pytest tests/models/abc_sanitizer/test_abc_sanitizer.py --log-cli-level=INFO
"""
...
from nauto_zoo.models.abc_sanitizer.abc_sanitizer import ABCSanitizer


class TestAbcSanitizerModel(unittest.TestCase):
    """Unit Test for AbcSanitizer Model"""

    def test_sanitizer_model_v1(self):
        ...
        config_provided_by_ucm = {"window_length": 5,
                                  ...
                                  "orient_sensor": True,
                                  "gravity_version": "0.1",
                                  "atypical_versionl": "0.1"
                                  }
        model = ABCSanitizer(config_provided_by_ucm)
    ...
    def test_sanitizer_model_v2(self):
