...
class PreprocessIMU(object):
    def __init__(self,
        ...
        self.end_ns = end_ns
        self._preprocess_imu(com_rec=com_rec,
    ...
    def to_feature_vector(self, agg_func=np.mean,
        ...
        try:
            ...
            result = {}
            result['pitch_angle'] = float(self.phi_xz * \
                            57.3 if self.orient_sensor else None)
            result.update(
